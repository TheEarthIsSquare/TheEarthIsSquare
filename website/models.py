...
class Profile(models.Model):
    ...
    avatar = models.ImageField(upload_to='website/images/profiles')
...
class Project(models.Model):
    ...
    main_image = models.ImageField(upload_to='website/images/projects', null = True)

class Image(models.Model):
    image = models.ImageField(upload_to='website/images/projects', null = True)
